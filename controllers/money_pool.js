...
// //@desc get one  contributors
// //@route Get /apiv1/money_pool/:id/contributors/:id
// //@access private
// //ok
// exports.updateContributer = async (req,response , next)=>{

//     console.log(req.body);
//     try{
//         const money = await money_pool.find(
//             {
//                 contributors:{_id: "5f9b2f458f3ffd29fc752a38"},
//             }
//             );
